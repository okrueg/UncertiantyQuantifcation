...
if rank == 0:
    data = model_utils.model_grid_generator( x_range=(0, 1), y_range=(0, 1), grid_size=(X_SIZE, Y_SIZE))
...
local_result = model_utils.model_grid_training(local_chunk,('use_activations', 'original_method'), train, val, test, EPOCHS, rank)
